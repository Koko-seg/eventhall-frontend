        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              <p className="text-lg text-gray-600">How would you like to get started with EventHalls?</p>
            </div>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <div className="text-xl font-bold mb-1">Do you want to register your event hall?</div>
                  <div className="text-sm opacity-90">Create your venue profile and start hosting events</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <div className="text-xl font-bold mb-1">Are you looking for an event hall?</div>
                  <div className="text-sm opacity-90">Browse venues and book your perfect event space</div>
                </div>
              </div>
            </Button>
          </div>
