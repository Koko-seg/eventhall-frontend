...
export default function SuperAdminDashboard() {
  ...
  useEffect(() => {
    ...
    const venueRegistrations = JSON.parse(localStorage.getItem("venueRegistrations") || "[]")

    setPendingAdmins(registeredUsers.filter((u: any) => u.role === "admin" && u.status === "pending"))
    setPendingVenues([
  ...
  const platformStats = {
    ...
    unreadEmails: emailNotifications.filter((email) => email.status === "sent").length,
  }
  ...
  const handleApproveAdmin = (adminId: number) => {
    ...
    const updatedUsers = registeredUsers.map((u: any) =>
      u.id === adminId ? { ...u, status: "approved", approvedAt: new Date().toISOString() } : u,
    )
  ...
  const handleRejectAdmin = (adminId: number) => {
    const registeredUsers = JSON.parse(localStorage.getItem("registeredUsers") || "[]")
    const updatedUsers = registeredUsers.map((u: any) =>
      u.id === adminId ? { ...u, status: "rejected", rejectedAt: new Date().toISOString(), rejectionReason } : u,
    )
    localStorage.setItem("registeredUsers", JSON.stringify(updatedUsers))
    setPendingAdmins(pendingAdmins.filter((admin) => admin.id !== adminId))
    setSelectedAdmin(null)
  ...
  const handleApproveVenue = (venueId: number) => {
    ...
    const updatedAdminVenues = adminVenues.map((v: any) =>
      v.id === venueId ? { ...v, status: "approved", approvedAt: new Date().toISOString() } : v,
    )
    ...
    localStorage.setItem("venueRegistrations", JSON.stringify(updatedVenueRegistrations))
  ...
  const handleRejectVenue = (venueId: number) => {
    ...
    const updatedAdminVenues = adminVenues.map((v: any) =>
      v.id === venueId ? { ...v, status: "rejected", rejectedAt: new Date().toISOString(), rejectionReason } : v,
    )
    const updatedVenueRegistrations = venueRegistrations.map((v: any) =>
      v.id === venueId ? { ...v, status: "rejected", rejectedAt: new Date().toISOString(), rejectionReason } : v,
    )
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="text-2xl font-bold text-purple-600">Super Admin Dashboard</div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <Card className="p-6 transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">{platformStats.totalVenues}</p>
                    </div>
                ...
                <Card className="p-6 transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">{platformStats.totalBookings}</p>
                    </div>
                ...
                <Card className="p-6 transform hover:scale-105 transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">{platformStats.pendingApprovals}</p>
                    </div>
                ...
                <Card className="p-6">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={monthlyData}>
                      ...
                      <Line type="monotone" dataKey="venues" stroke="#F59E0B" strokeWidth={3} name="Venues" />
                      <Line type="monotone" dataKey="bookings" stroke="#10B981" strokeWidth={3} name="Bookings" />
                    </LineChart>
                  </ResponsiveContainer>
                </Card>
              ...
              <Card className="p-6">
                ...
                <div className="grid md:grid-cols-5 gap-4">
                  ...
                  >
                    ...
                    {platformStats.unreadEmails > 0 && (
                      <Badge className="bg-red-500 text-white">{platformStats.unreadEmails} unread</Badge>
                    )}
                  </Button>
                  ...
                  >
                    ...
                    {pendingAdmins.length > 0 && (
                      <Badge className="bg-red-500 text-white">{pendingAdmins.length} pending</Badge>
                    )}
                  </Button>
                  ...
                  >
                    ...
                    {pendingVenues.length > 0 && (
                      <Badge className="bg-red-500 text-white">{pendingVenues.length} pending</Badge>
                    )}
                  </Button>
            ...
            <TabsContent value="pending-admins" className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900">Pending Admin Approvals</h2>
                <div className="flex items-center gap-4">
              ...
              {pendingAdmins.length === 0 ? (
                <Card className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">No Pending Admin Approvals</h3>
                  <p className="text-gray-600">All venue owner applications have been reviewed.</p>
                </Card>
              ) : (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {pendingAdmins.map((admin) => (
                    <Card key={admin.id} className="p-6 transform hover:scale-105 transition-all duration-300">
                      ...
                      <div className="space-y-2 mb-6">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <Badge className="bg-purple-100 text-purple-800">Venue Owner</Badge>
                        </div>
                        <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        <Button size="sm" onClick={() => setSelectedAdmin(admin)} variant="outline" className="flex-1">
            ...
            <TabsContent value="pending-venues" className="space-y-6">
              ...
              {pendingVenues.length === 0 ? (
                <Card className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">No Pending Venue Approvals</h3>
                  <p className="text-gray-600">All venue submissions have been reviewed.</p>
                </Card>
              ) : (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {pendingVenues.map((venue) => (
                    ...
                    >
                      <div className="relative">
                        ...
                        />
                        <Badge className="absolute top-4 right-4 bg-yellow-100 text-yellow-800">Pending Review</Badge>
                      </div>
                      <div className="p-6">
                        ...
                        <div className="space-y-2 mb-6">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">${venue.pricePerEvent || venue.price}</span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">Submitted:</span>
                            <span className="font-medium">
                              {new Date(venue.createdAt || venue.submittedAt).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input id="supportEmail" type="email" defaultValue="support@eventspace.com" />
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Automatically approve venues from verified owners</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Send email alerts for new submissions</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Require additional verification for new venues</p>
                      </div>
                      <input type="checkbox" defaultChecked className="rounded" />
                    </div>
            ...
            <Card className="w-full max-w-2xl bg-white shadow-2xl">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">Review Admin Application</h2>
                  <Button
                    variant="ghost"
                    size="sm"
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <Badge className="bg-purple-100 text-purple-800 mt-1">Venue Owner Application</Badge>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-lg">{new Date(selectedAdmin.createdAt).toLocaleDateString()}</p>
                    </div>
                    <div>
        ...
        {selectedVenue && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">Review Venue Submission</h2>
                  <Button
                    variant="ghost"
                    size="sm"
                ...
                <div className="space-y-6">
                  ...
                  {selectedVenue.images && selectedVenue.images.length > 0 && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">Venue Images</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <Label className="text-sm font-semibold text-gray-600">Venue Name</Label>
                        ...
                        <div>
                          ...
                          <p className="text-lg">{selectedVenue.capacity} guests</p>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-lg">
                            {new Date(selectedVenue.createdAt || selectedVenue.submittedAt).toLocaleDateString()}
                          </p>
                        </div>
                        ...
                        {selectedVenue.eventTypes && selectedVenue.eventTypes.length > 0 && (
                          <div>
                            <Label className="text-sm font-semibold text-gray-600">Event Types</Label>
                            <div className="flex flex-wrap gap-2 mt-1">
                  ...
                  {selectedVenue.description && (
                    <div>
                      ...
                      <p className="text-gray-900 mt-1">{selectedVenue.description}</p>
                    </div>
                  )}

                  <div>
                    <Label htmlFor="venueRejectionReason">Rejection Reason (if rejecting)</Label>
                    <Textarea
